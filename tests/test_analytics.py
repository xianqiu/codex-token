...
from codex_token_count.analytics import build_daily_trend, build_summary, summarize_projects, top_sessions
...
class AnalyticsTests(unittest.TestCase):
    def test_build_summary(self) -> None:
        summary = build_summary(make_threads(), now=ts("2026-03-15T00:00:00+00:00"))
